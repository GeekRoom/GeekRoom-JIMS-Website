...
## 📋 3. Department Head Fields Reference Table

When filling in details for new department leads, refer to this prop structure:

| Field Name | Description | Example Value |
| :--- | :--- | :--- |
| **Name** | Full Name of the Head | `Rohan Verma` |
| **Department Tag** | Division / Domain | `Technical`, `Events`, `Design`, `PR` |
| **Badge Title** | Official Title | `Tech Lead`, `President`, `PR Lead` |
| **Avatar Image** | Square photo / headshot | Unsplash URL or `assets/team/rohan.jpg` |
| **Bio & Year** | Course & brief responsibility | `BCA 3rd Year • Leads code reviews` |
| **Social Links** | LinkedIn, GitHub, Email | `https://linkedin.com/in/username` |
